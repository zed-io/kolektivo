...
type AnimatedScannerSceneProps = NativeStackScreenProps<
  QRTabParamList,
...
function AnimatedScannerScene({ route, position }: AnimatedScannerSceneProps) {
  ...
  return (
    <Animated.View style={animatedStyle}>
      ...
      {enableCamera && <QRKolektivoScanner onQRCodeDetected={onQRCodeDetectedWrapper} />}
    </Animated.View>
  )
}
...
type Props = NativeStackScreenProps<StackParamList, Screens.QRKolektivoNavigator>

export default function QRKolektivoNavigator({ route }: Props) {
  ...
  return (
    ...
    >
      ...
      <Tab.Screen name={Screens.QRKolektivoScanner} options={{ title: t('scanCode') ?? undefined }}>
...
QRKolektivoNavigator.navigationOptions = {
  ...noHeader,
  ...Platform.select({
