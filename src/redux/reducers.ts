...
import { State as MapState, reducer as map } from 'src/kolektivo/map/reducer'
import { State as VendorState, reducer as vendor } from 'src/kolektivo/vendors/reducer'
